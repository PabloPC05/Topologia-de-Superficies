...
\begin{definición}[Compacto]
    Un espacio topológico $(X, \tau)$ es compacto si todo recubrimiento abierto de $(X, \tau)$ adimite un recubrimiento finito, es decir, 
...
\begin{proof}
    ...
    $$A = A \cap X = A \cap \left(\bigcup_{i = n} U_{x_i}\right) = \bigcup_{i = n} (A \cap U_{x_i})$$
...
\begin{definición}[Subespacio compacto]
    Sean $X$ un espacio topológico y $A \subset X$ un subespacio de $X$. Decimos que $A$ es un subespacio compacto si esl espacio topológico $(A, \tau_A)$ es compacto donde $\tau_A = \{A \cap U : U \in \tau\}$ es la topología relativa de $A$.
\end{definición}
\begin{proposición}
